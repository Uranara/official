                ...
                <div
                    ...
                    <div className={"whitespace-normal"}>
                        ...
                        <div className={"flex justify-center pt-10 pb-10"}>
                            <Image src={"/pic1.jpeg"} alt={"panel"} width={"800"} height={"600"}
                        ...
                        <div className={"flex justify-center pt-10 pb-10"}>
                            <Image src={"/pic2.jpeg"} alt={"panel"} width={"800"} height={"600"}
                                   className={"rounded-2xl"}></Image>
                        </div>
                        <p>
                            {t('p4')}
                        ...
                        <div className={"flex justify-center pt-10 pb-10"}>
                            <Image src={"/pic3.jpeg"} alt={"panel"} width={"800"} height={"600"}
                                   className={"rounded-2xl"}></Image>
                        </div>
                        <p>
                            {t('p5')}
